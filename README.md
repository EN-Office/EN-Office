...
2年弱の中で上層部との意思決定フローの確認や制作全体の流れ、KPI達成のためのアジャイル開発とPDCAのサイクルを学び、概ねゲーム業界での制作業務において違いがないことを認識し、別業界へ。
XRやメタバースがコロナ禍で今後注目されうる時代が来ると信じmonoAItechnology株式会社へ転職。
メタバースイベント、OEMメタバース開発、体験型VRコンテンツ、ARコンテンツ開発を通してUnityでの3Dデザインを活用したアプリケーションによって企業のDX支援を援助。
